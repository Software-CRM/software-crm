...
const AdminDashboard = ({ user, onLogout }) => {
  ...
  // Profile data — seeded from the `user` prop (backend-sourced)
  ...
  const handleSaveProfile = () => {
    ...
    // TODO: Replace alert with backend API call when endpoint is ready
    // await apiFetch('/api/admin/profile/update', { method: 'PUT', body: profileData });
            ...
            <div className="topbar-actions">
              ...
              <div className="profile-wrapper">
                <div
                  ...
                  role="button"
                  tabIndex={0}
                  onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') toggleProfileMenu(); }}
                >
                  <div className="avatar-small">
                    <UserIcon size={18} />
                  </div>
                  <div className="user-info">
                    <span className="u-name">{profileData.fullName}</span>
                    <span className="u-role">{profileData.role}</span>
                  </div>
                  <ChevronDown
                    size={14}
